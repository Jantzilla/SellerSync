 ...
 */
public class RakutenSetupFragment extends Fragment {
    DbHelper dbHelper;
    EditText channelName;
    Button setup;
    String channelPrefix = "[RAKUTEN]";


    public RakutenSetupFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_rakuten_setup, container, false);
    }
