 ...
 */
public class BigcommerceSetupFragment extends Fragment {
    DbHelper dbHelper;
    EditText channelName;
    Button setup;
    String channelPrefix = "[BIGCOMMERCE]";


    public BigcommerceSetupFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_bigcommerce_setup, container, false);
    }
