 ...
 */
public class MagentoSetupFragment extends Fragment {
    DbHelper dbHelper;
    EditText channelName;
    Button setup;
    String channelPrefix = "[MAGENTO]";


    public MagentoSetupFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_magento_setup, container, false);
    }
