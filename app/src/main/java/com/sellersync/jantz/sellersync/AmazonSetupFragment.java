 ...
 */
public class AmazonSetupFragment extends Fragment {
    DbHelper dbHelper;
    EditText channelName;
    Button setup;
    String channelPrefix = "[AMAZON]";


    public AmazonSetupFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_amazon_setup, container, false);
    }
