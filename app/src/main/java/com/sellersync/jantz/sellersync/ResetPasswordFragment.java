...
public class ResetPasswordFragment extends Fragment {
    ...
    public void queryCity(final String query) {
        ...
        final FunDapter adapter= new FunDapter(ResetPasswordFragment.this.getActivity(),summary,R.layout.summary_layout,dictionary);
        ...
        newPassword = (EditText) getActivity().findViewById(R.id.etNewPassword);
                ...
                try {
                    ...
                    Submit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            submitPassword = newPassword.getText().toString();
                            if (MD5.encrypt(etUsers.getText().toString()).equals(employeeUsername) || etUsers.getText().toString().equalsIgnoreCase(employeeName) || etUsers.getText().toString().equalsIgnoreCase(employeeTitle) || etUsers.getText().toString().equalsIgnoreCase(employeeDepartment)) {
                                if (!submitPassword.equals("")) {
                                    ...
                                    Response.Listener<String> responseListener2 = new Response.Listener<String>() {
                                        ...
                                        public void onResponse(String response2) {
                                            try {
                                                ...
                                                if (success) {
                                                    Toast.makeText(getContext(),"Selected user's password has been updated.", Toast.LENGTH_LONG).show();
                                    ...
                                    ResetPassRequest resetPassRequest = new ResetPassRequest(employeeUsername, submitPassword, responseListener2);
                                    RequestQueue queue = Volley.newRequestQueue(getActivity().getApplicationContext());
        ...
        etUsers.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (etUsers.getText().toString().length() >=2) {
                    ...
                    FunDapter adapter= new FunDapter(ResetPasswordFragment.this.getActivity(),summary,R.layout.summary_layout,dictionary);
                    final ListView listView = (ListView) getActivity().findViewById(R.id.lvUsers);
                    listView.setAdapter(adapter);
                }
                else {
